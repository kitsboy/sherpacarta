...
---
# SherpaCarta — Investor / Partner One-Pager

**Live:** [https://sherpacarta.org](https://sherpacarta.org) · **GitHub:** [https://github.com/kitsboy/sherpacarta](https://github.com/kitsboy/sherpacarta) · **Version:** `0.0.0+` · **Status:** LIVE

## One sentence
Global Digital Magna Carta — 114 articles for digital rights (CC0).

## Problem
No universal, living digital-rights charter for the AI/surveillance era.

## Solution
114-article interactive charter, signing, education; CC0; Bitcoin-funded.

## Who it's for
Citizens, organizers, educators, policymakers, privacy advocates.

## Stage
Live charter + community MVP

## Traction (honest)
Live sherpacarta.org; full article set; multi-language SEO docs.

## Model / value flow
Public-good charter; Bitcoin donations; no user monetization/tracking.
...
| Risk | Mitigation |
|------|------------|
| Governance of living document | Article 114 expansion-only principle |
| Impact without legal teeth | Moral/political instrument; partner advocacy |

## The ask (default — refine per conversation)
Translators, legal scholars, organizers, grant funders for rights work.

## Demo path (60 seconds)
1. Open https://sherpacarta.org
