...
const staticUrls = [
  ...
  { loc: 'https://sherpacarta.org/share.html', priority: '0.8', changefreq: 'monthly' },
  { loc: 'https://sherpacarta.org/rights.html', priority: '0.9', changefreq: 'monthly' },
  { loc: 'https://sherpacarta.org/briefing.html', priority: '0.9', changefreq: 'monthly' },
  { loc: 'https://sherpacarta.org/briefing-fr.html', priority: '0.85', changefreq: 'monthly' },
  { loc: 'https://sherpacarta.org/leave-behind.html', priority: '0.9', changefreq: 'monthly' },
  ...
  { loc: 'https://sherpacarta.org/canada/paper', priority: '0.9', changefreq: 'weekly' },
  { loc: 'https://sherpacarta.org/canada/official', priority: '0.85', changefreq: 'weekly' },
  { loc: 'https://sherpacarta.org/canada/organizer', priority: '0.75', changefreq: 'monthly' },
  { loc: 'https://sherpacarta.org/canada/proof', priority: '0.8', changefreq: 'weekly' },
  { loc: 'https://sherpacarta.org/canada/bc/', priority: '0.9', changefreq: 'weekly' },
  { loc: 'https://sherpacarta.org/canada/proof', priority: '0.85', changefreq: 'weekly' },
  { loc: 'https://sherpacarta.org/canada/about', priority: '0.8', changefreq: 'monthly' },
  { loc: 'https://sherpacarta.org/security', priority: '0.7', changefreq: 'monthly' },
  { loc: 'https://sherpacarta.org/verify.html', priority: '0.8', changefreq: 'weekly' },
