...
const ASSETS = [
  ...
  '/sc-main.css', '/js/sc-top30.js', '/js/sc-next100.js', '/js/sc-reliability.js', '/js/sc-proof-tools.js', '/js/sc-proof-lifecycle.js', '/js/sc-route-ux.js', '/js/sc-rights-reader.js', '/js/sc-disclosure.js', '/data/external-gates.json', '/sc-core.js', '/sc-bundle.js', '/embed.js', '/data/charter.json',
  '/fonts/fonts.css',
