/**
 * Thin Satohash timestamp client for SherpaCarta.
 * Public API only — no secrets. Identify traffic via X-Satohash-Client.
 *
 * Usage:
 *   import { stampHash, getApiHealth } from './lib/satohash.js'
 *   const health = await getApiHealth()
 *   const proof = await stampHash(sha256Hex, { filename: 'charter-v2.json' })
 */
