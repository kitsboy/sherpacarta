...
**Date:** 2026-09-08
**BUILD:** curated home bundle · SW **v9.6** · local sign vs Canada campaign
...
- `public/sw.js` — Service worker **v9.6** (network-first HTML; no cache for `/api/canada/*`; proof lifecycle and governance assets cached)
