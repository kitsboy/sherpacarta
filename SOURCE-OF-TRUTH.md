...
**Date:** 2026-09-08
**BUILD:** first-choice journey · SW **v9.5** · local sign vs Canada campaign
...
- `public/sw.js` — Service worker **v9.5** (network-first HTML; no cache for `/api/canada/*`; proof lifecycle and governance assets cached)
